...
const SettingsPage = () => {
  return (
    ...
    >
      <h1 className="text-3xl font-display font-bold text-slate-900 dark:text-white">Einstellungen</h1>
      <p className="text-slate-500 dark:text-slate-400 mt-1">Sportfest Konfiguration</p>
      ...
      <div className="mt-8 bg-white dark:bg-slate-800 rounded-xl shadow-sm p-8 flex items-center justify-center h-64">
        <div className="text-center">
          ...
          <p className="text-slate-500 dark:text-slate-400">
            Hier würden die Einstellungen für das Sportfest erscheinen.
          </p>
        </div>
      </div>
    </motion.div>
