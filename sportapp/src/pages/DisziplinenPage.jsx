...
const DisziplinenPage = () => {
  ...
  return (
    <motion.div
      className="p-4 md:p-6 lg:p-8 min-h-screen bg-slate-100 dark:bg-slate-900"
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-6 md:mb-8">
          {/* <h1 className="text-3xl md:text-4xl font-bold text-slate-800 dark:text-slate-100">Disziplinen</h1> */}
          {isAdmin() && (
            <button
              onClick={openAddModal}
              className="px-4 py-2 bg-sky-600 text-white rounded-lg flex items-center hover:bg-sky-700 transition-colors shadow-md hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2 dark:focus:ring-offset-slate-900"
            >
                  ...
                  >
                    <div className="p-5">
                      ...
                      <div className="mt-4 flex justify-end space-x-2">
                        <Link 
                          to={`/disziplinen/${disziplin.DISZIPLINID}`}
                          className="p-2 rounded-lg text-slate-600 hover:text-slate-900 dark:text-slate-300 dark:hover:text-white bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors inline-flex items-center justify-center"
                        >
                          <Info size={18} />
                        </Link>
                        <Link 
                          to={`/disziplinen/${disziplin.DISZIPLINID}/edit`}
                          className="p-2 rounded-lg text-slate-600 hover:text-indigo-600 dark:text-slate-300 dark:hover:text-indigo-400 bg-slate-100 dark:bg-slate-800 hover:bg-indigo-50 dark:hover:bg-indigo-900/20 transition-colors inline-flex items-center justify-center"
                        >
                          <Edit size={18} />
                        </Link>
                        <motion.button 
